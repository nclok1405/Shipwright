...
std::vector<ValueTableElement> valueTable = {
    ...
    { "Free Look Camera X", "play->camX",                           "CAMX:",   TYPE_FLOAT, true,  []() -> void* { return &gPlayState->camX; },                          WHITE },
    { "Free Look Camera Y", "play->camY",                           "CAMY:",   TYPE_FLOAT, true,  []() -> void* { return &gPlayState->camY; },                          WHITE },
